...
- [Choose Messaging Channels](../manage-sandboxes/messaging-channels/choose-messaging-channels) to learn how to connect Telegram, Slack, or Discord.
- [Switch Inference Providers](../inference/manage-inference/switch-providers) to learn how to change the model provider after setup.
